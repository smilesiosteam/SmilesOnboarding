...
public class AROTPTextField: UITextField {
    ...
    public func configure(with slotCount: Int = 4) {
        ...
        NSLayoutConstraint.activate([
            labelsStackView.widthAnchor.constraint(equalToConstant: SmilesUtilities.SharedConstants.ScreenSize.width - 32),
            labelsStackView.heightAnchor.constraint(equalToConstant: SmilesUtilities.SharedConstants.ScreenSize.width / CGFloat(slotCount) - otpDigitSpacing - 5)
        ])
    }
